...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Br=Dr,Vr=Br.NEGATIVE_INFINITY,cr=Vr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ca=br;function Xa(r){return Ca.call(r)}var Da=Xa;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ka=ja,re=Da,ae=Za,F;ka()?F=ae:F=re;var g=F;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Xe=He,De=je,Be=Ce,M;Xe()?M=De:M=Be;var x=M;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var tr=Rt,Ar;function Ct(){var r,a;return r=new tr.uint16(1),r[0]=4660,a=new tr.uint8(r.buffer),a[0]===52}Ar=Ct();var Xt=Ar;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var sn=J,Ir,C,X;sn===!0?(C=1,X=0):(C=0,X=1);Ir={HIGH:C,LOW:X};var cn=Ir;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Xn=Tr;function Dn(r){return Xn(r,[0,0],1,0)}var Bn=Dn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
